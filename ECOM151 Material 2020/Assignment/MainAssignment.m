...
TrainData = readtable('trainData.csv','ReadVariableNames',true);
TestData  = readtable('testData.csv','ReadVariableNames',true);

y = +strcmp(TrainData.loan_status,'Charged Off');
